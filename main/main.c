...
#define ESP_WIFI_SSID "Adil"
#define ESP_WIFI_PASSWORD "adil@123"
...
char html_page[] = "<!DOCTYPE HTML><html>\n"
                   "<head>\n"
                   "  <title>Heuristic Academy DHT22 Server</title>\n"
                   ...
                   "<body>\n"
                   "  <div class=\"topnav\">\n"
                   "    <h3>Heuristic Academy DHT22 Server</h3>\n"
                   "  </div>\n"
                   "  <div class=\"content\">\n"
                   "    <div class=\"cards\">\n"
...
{
    int response;
    DHT_readings();// data in temp and hum
    char response_data[sizeof(html_page) + 50];
    memset(response_data, 0, sizeof(response_data)); //clear
